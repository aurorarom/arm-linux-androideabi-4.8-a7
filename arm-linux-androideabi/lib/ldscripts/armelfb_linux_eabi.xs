...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/media/adrianomartins/Toolchain/out/arm-linux-androideabi-4.8-cortex-a7/arm-linux-androideabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
